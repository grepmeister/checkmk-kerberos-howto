...
msktutil \
  ...
  --enctypes 0x10 \ <4>
  --service HTTP/monitoring.mycompany.tld <5>
----
...
ktpass ^
   ...
   -out c:\Temp\svc_http_remote.keytab ^
...
[TIP]
====
* once you copied the c:\Temp\svc_http_remote.keytab into your checkmk site you shold remove the file as is contains a valid domain password.
* it can take up to n minutes that this gets replicated to your other domain controllers.
====

* Verify Service Principal to User mapping
----
C:\Users\Administrator>setspn -L svc_http_checkmk
