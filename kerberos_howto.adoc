...
*--server use one of your active directory servers
* --keytab the name of your keytab file
* --realm your kerberos realm
* --enctypes 0x10 stands for aes256-cts-hmac-sha1
* --service your {SP} in the form *HTTP/<FQDN>*
